...
*/
     ...
     * @return 进度条
     */
    public String songPar() {
        if (nowSong == null)
            return "没有正在播放的曲目！";
        StringJoiner sj = new StringJoiner(" ", Progress.getFt(musicTick), Progress.getFt(nowSong.getLength()));
        sj.add("").add(Progress.addPar(musicTick, nowSong.getLength(), false)).add("");
        return sj.toString();
    }
